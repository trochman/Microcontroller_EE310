...
; Initialization
;---------------------
#include "D:\SSU\EE_310_LAB\AssemblyConfig.inc"
#include <xc.inc>

;---------------------
; Program Inputs
;---------------------
Inner_loop  equ 200 // in decimal
Outer_loop  equ 5
...
_start1: 
    BANKSEL	PORTD ;
    CLRF	PORTD,A ;Init PORTA
    BANKSEL	LATD ;Data Latch
    CLRF	LATD,A ;
    BANKSEL	ANSELD ;
    CLRF	ANSELD,A ;digital I/O
    BANKSEL	TRISD ;
    MOVLW	0b11111110 ;Set RD[7:1] as inputs
    MOVWF	TRISD,A ;and set RD0 as ouput
    
_onoff:
    BTFSC	SWITCH,A  ; By removing these two lines the input has no impact 
