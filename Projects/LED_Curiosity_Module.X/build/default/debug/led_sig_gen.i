...
# 1 "D:\\SSU\\EE_310_LAB\\AssemblyConfig.inc" 1
;-------------------------------------------------------------------
...
_start1:
    ...
    MOVWF TRISD,A ;and set ((PORTD) and 0FFh), 0, a as ouput

_onoff:
    BTFSC PORTD,1,A ; By removing these two lines the input has no impact
