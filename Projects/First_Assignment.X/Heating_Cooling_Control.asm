...
; Initialization
;---------------------
#include "D:\SSU\EE_310_Lab\Projects\First_Assignment.X\AssemblyConfig.inc"
#include <xc.inc>

;---------------------
; Program Inputs
;---------------------
#define  refTemp			10  ; keypad reference input temp
#define  measuredTemp			-10  ; measured sensor input temp
