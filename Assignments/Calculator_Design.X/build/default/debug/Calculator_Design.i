...
# 2 "<built-in>" 2
# 1 "Calculator_Design.c" 2
# 34 "Calculator_Design.c"
...
# 34 "Calculator_Design.c" 2

# 1 "D:\\SSU\\EE_310_Lab\\Assignments\\Calculator_Design.X\\ConfigFile.h" 1
# 71 "D:\\SSU\\EE_310_Lab\\Assignments\\Calculator_Design.X\\ConfigFile.h"
...
# 35 "Calculator_Design.c" 2
# 44 "Calculator_Design.c"
...
const int __attribute__((address(0x30))) keypad[4][4] = {1, 2, 3, 10,
                              4, 5, 6, 11,
                              7, 8, 9, 12,
                              14, 0, 15, 13};

void __attribute__((address(0x60))) main(void) {
    ...
    while(1) {
        ...
        _delay((unsigned long)((500)*(4000000/4000.0)));
        while(PORTB == 0x0F);
        Operation(X_Input_REG, Y_Input_REG, Operation_REG);
        _delay((unsigned long)((500)*(4000000/4000.0)));
        while(PORTB == 0x0F);
    }
    return;
