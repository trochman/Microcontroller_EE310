...
# 2 "<built-in>" 2
# 1 "Interfacing_Sensors.c" 2
# 30 "Interfacing_Sensors.c"
...
# 30 "Interfacing_Sensors.c" 2

# 1 "D:\\SSU\\EE_310_Lab\\Assignments\\Interfacing_Sensors.X\\ConfigFile.h" 1
# 71 "D:\\SSU\\EE_310_Lab\\Assignments\\Interfacing_Sensors.X\\ConfigFile.h"
...
void __attribute__((picinterrupt(("irq(INT0), base(0x4008)")))) interrupt1_ISR(void){
...
void __attribute__((address(0x90))) main(void) {
