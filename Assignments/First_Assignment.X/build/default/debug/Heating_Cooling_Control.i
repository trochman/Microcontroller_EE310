# 1 "Heating_Cooling_Control.asm"
# 1 "<built-in>" 1
# 1 "Heating_Cooling_Control.asm" 2
;---------------------
...
# 1 "D:\\SSU\\EE_310_Lab\\Projects\\First_Assignment.X\\AssemblyConfig.inc" 1
;---------------------
...
# 30 "Heating_Cooling_Control.asm" 2
# 1 "C:\\Program Files\\Microchip\\xc8\\v2.46\\pic\\include\\xc.inc" 1 3




# 1 "D:/SSU/packs/Microchip/PIC18F-K_DFP/1.13.292/xc8\\pic\\include\\pic18.inc" 1 3





# 1 "D:/SSU/packs/Microchip/PIC18F-K_DFP/1.13.292/xc8\\pic\\include\\pic18_chip_select.inc" 1 3
# 254 "D:/SSU/packs/Microchip/PIC18F-K_DFP/1.13.292/xc8\\pic\\include\\pic18_chip_select.inc" 3
# 1 "D:/SSU/packs/Microchip/PIC18F-K_DFP/1.13.292/xc8\\pic\\include\\proc\\pic18f47k42.inc" 1 3
# 47 "D:/SSU/packs/Microchip/PIC18F-K_DFP/1.13.292/xc8\\pic\\include\\proc\\pic18f47k42.inc" 3
...
TOSU equ 03FFFh
# 35665 "D:/SSU/packs/Microchip/PIC18F-K_DFP/1.13.292/xc8\\pic\\include\\proc\\pic18f47k42.inc" 3
...
# 255 "D:/SSU/packs/Microchip/PIC18F-K_DFP/1.13.292/xc8\\pic\\include\\pic18_chip_select.inc" 2 3
# 7 "D:/SSU/packs/Microchip/PIC18F-K_DFP/1.13.292/xc8\\pic\\include\\pic18.inc" 2 3
...
# 31 "Heating_Cooling_Control.asm" 2
...
; REGISTERS
;---------------------
refTempREG SET 0x20 ; register to store 10 ; keypad reference input temp
measuredTempREG SET 0x21 ; register to store -10 ; measured sensor input temp
contREG SET 0x22 ; register to store comparison result

;---------------------
; Program Outputs
;---------------------
refTempLowDig SET 0x60 ; register to store the 10 ; keypad reference input temp decimal ones digit for display
refTempMidDig SET 0x61 ; register to store the 10 ; keypad reference input temp decimal tens digit for display
refTempHighDig SET 0x62 ; register to store the 10 ; keypad reference input temp decimal hundreds digit for display
measuredTempLowDig SET 0x70 ; register to store the -10 ; measured sensor input temp decimal ones digit for display
measuredTempMidDig SET 0x71 ; register to store the -10 ; measured sensor input temp decimal tens digit for display
measuredTempHighDig SET 0x72 ; register to store the -10 ; measured sensor input temp decimal hundreds digit for display
...
;---------------------
 ...
 MOVLW 10 ; keypad reference input temp ; WREG = 10 ; keypad reference input temp
 MOVWF refTempREG,A ; store 10 ; keypad reference input temp in refTempREG
 CALL RDEC ; call RDEC function to get decimal value of 10 ; keypad reference input temp for display
 MOVLW -10 ; measured sensor input temp ; WREG = -10 ; measured sensor input temp
 MOVWF measuredTempREG,A ; store -10 ; measured sensor input temp in measuredTempREG
 ADDLW 0 ; Add 0 to WREG to set STATUS register
 BN NEGM ; Branch to NEGM if -10 ; measured sensor input temp is negative
 CALL MDEC ; call MDEC function to get decimal value of -10 ; measured sensor input temp for display
 MOVLW -10 ; measured sensor input temp ; WREG = -10 ; measured sensor input temp
 SUBLW 10 ; keypad reference input temp,A ; WREG = 10 ; keypad reference input temp - -10 ; measured sensor input temp
 BN COOL ; Branch to COOL if 10 ; keypad reference input temp < -10 ; measured sensor input temp
 BZ NOTHING ; Branch to NOTHING if 10 ; keypad reference input temp = -10 ; measured sensor input temp
HEAT: MOVLW 0x01 ; Otherwise 10 ; keypad reference input temp > -10 ; measured sensor input temp
...
lowRD: INCF tempQuo,A ; Increment temporary quotient
 ...
 MOVFF tempNum,refTempLowDig ; Store ones digit of 10 ; keypad reference input temp for display
...
midRD: INCF tempQuo,A ; Increment temporary quotient
 ...
 ADDWF tempNum,A ; WREG = tempNum + 10
 DECF tempQuo,A ; Decrement temporary quotient
 MOVFF tempNum,refTempMidDig ; Store tens digit of 10 ; keypad reference input temp for display
 MOVFF tempQuo,refTempHighDig ; Store hundreds digit of 10 ; keypad reference input temp for display
...
lowMD: INCF tempQuo,A ; Increment temporary quotient
 ...
 ADDWF tempNum,A ; WREG = tempNum + 10
 DECF tempQuo,A ; Decrement temporary quotient
 MOVFF tempNum,measuredTempLowDig ; Store ones digit of 10 ; keypad reference input temp for display
 MOVFF tempQuo,tempNum,A ; Move temporary quotient to temporary numerator
 MOVLW 0x00 ; WREG = 0
 MOVWF tempQuo,A ; Clear temporary quotient
 MOVLW 0x0A ; WREG = 10
midMD: INCF tempQuo,A ; Increment temporary quotient
 ...
 ADDWF tempNum,A ; WREG = tempNum + 10
 DECF tempQuo,A ; Decrement temporary quotient
 MOVFF tempNum,measuredTempMidDig ; Store tens digit of -10 ; measured sensor input temp for display
 MOVFF tempQuo,measuredTempHighDig ; Store hundreds digit of -10 ; measured sensor input temp for display
 RETURN ; Return to main program
