# 1 "Counter_wbuttons.asm"
# 1 "<built-in>" 1
# 1 "Counter_wbuttons.asm" 2
;---------------------
...
# 1 "D:\\SSU\\EE_310_LAB\\Assignments\\Counter_wbuttons.X\\AssemblyConfig.inc" 1
;-------------------------------------------------------------------
; THIS FILE MUST BE PLACED IN THE HEADER FOLDER OF THE PROJECT
;-------------------------------------------------------------------
;---------------------
...
;---------------------
    ...
    BANKSEL TRISD ;
    MOVLW 0b10000000 ;Set ((NVMCON1) and 0FFh), 0, b[6:0] as outputs
    MOVWF TRISD
    BANKSEL PORTB ;
    ...
    BANKSEL TRISB ;
    MOVLW 0b00000011 ;Set ((PORTB) and 0FFh), 1, a and ((PORTB) and 0FFh), 0, a as inputs
    MOVWF TRISB
